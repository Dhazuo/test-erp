<template>
    <main-layout>
        <template v-slot:content>
            <div class="p-2">
                <div class="rounded-md shadow-md w-full border border-gray-200">
                            ...
                            <tr v-for="product in products.data" class="text-gray-500">
                                ...
                                <td class="flex justify-center">
                                    <div class="p-2 grid grid-cols-2 gap-x-1">
                                        <div>
                                            <inertia-link :href="route('management.product.edit', product)" class="text-green-500">Editar</inertia-link>
                                        </div>
                                        <div>
    ...
    <div v-if="deleting" class="fixed z-50 w-full h-full top-0 bg-black bg-opacity-50 flex justify-center items-center">
        ...
        <div v-else class="rounded-md bg-white p-4 grid grid-cols-1 gap-y-4">
            ...
            <div class="grid grid-cols-1">
                <input v-model="password" type="password" class="text-center rounded-md shadow-sm border border-gray-200 w-full">
