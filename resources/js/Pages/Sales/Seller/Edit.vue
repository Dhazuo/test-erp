                        ...
                        <tr v-for="(product, index) in form.products" class="border-b border-gray-200">
                            ...
                            <td class="p-2 flex justify-center">
                                <input v-model="product.stock" type="number"
                                       class="w-24 text-center text-sm focus:ring-0 rounded-md outline-none border border-gray-200 shadow-sm focus:outline-none focus:border-main transition duration-200">
                            </td>
                            ...
                            <td>
                                <button @click="deleteFromProducts(index)"
                                        class="rounded-full shadow-sm bg-red-500 h-6 w-6 text-white text-center flex justify-center items-center font-bold hover:bg-red-600 transition duration-200 text-xs">
                                    X
                                </button>
                            </td>
                        </tr>
